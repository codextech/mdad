...
const TableHead = React.forwardRef(({className, ...props}, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-center align-middle text-base text-[17px] font-normal text-white [&:has([role=checkbox])]:pr-0 dark:text-gray-400 font-abel ",
      className
    )}
    {...props}
  />
...
const TableCell = React.forwardRef(({className, ...props}, ref) => (
  <td
    ref={ref}
    className={cn(
      "h-11 p-2 px-4 align-middle text-base text-[17px] font-normal text-white font-abel [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
